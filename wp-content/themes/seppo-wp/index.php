...
<div id="content" class="site-content">    
    ...
    if (have_posts()) :
        ...
        echo '<div class="clear"></div>
              ...
              <a target="_self" class="more-posts">' . esc_html__('LOAD MORE', 'seppo-wp') . '</a>
              <a class="more-posts-loading">' . esc_html__('LOADING', 'seppo-wp') . '</a>
              <a class="no-more-posts">' . esc_html__('NO MORE', 'seppo-wp') . '</a>
              </div>';
    endif;
    echo '<div class="clear"></div>';
    ?>   
